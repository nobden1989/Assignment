 ...
 */
public class SplayTree<AnyType extends Comparable<? super AnyType>> extends ATree<AnyType> {
	/**
	 * Construct the tree.
	 */
	public SplayTree() {
	...
	private BinaryNode<AnyType> header = new BinaryNode<AnyType>(null); // For
																		// splay
