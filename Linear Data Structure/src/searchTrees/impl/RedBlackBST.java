...
public class RedBlackBST<Key extends Comparable<Key>, Value> extends ATree<Key> {
	...
	@Override
	public boolean myContains(Key x) {
		this.contains(x);
		return true;
	}

	@Override
	public boolean myRemove(Key x) {
		this.delete(x);
		return true;
	}
}