 ...
 */
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>> extends ATree<AnyType> {
	/**
	 * Construct the tree.
	 */
	 ...
	 * 
	 * while (t != null) { int compareResult = x.compareTo( t.element );
	 * 
	 * if( compareResult < 0 ) t = t.left; else if( compareResult > 0 ) t =
	 * t.right; else ; // Duplicate; do nothing } return t; }
	 */
