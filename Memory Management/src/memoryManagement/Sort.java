...
public final class Sort {
	 ...
	 */
	private static <AnyType extends Comparable<? super AnyType>> void percDown(AnyType[] a, int i,
			int n) {
		int child;
		AnyType tmp;
	...
	private static <AnyType extends Comparable<? super AnyType>> void mergeSort(AnyType[] a,
			AnyType[] tmpArray, int left, int right) {
		if (left < right) {
	 ...
	 */
	private static <AnyType extends Comparable<? super AnyType>> AnyType median3(AnyType[] a,
			int left, int right) {
		int center = (left + right) / 2;
	 ...
	 */
	public static <AnyType extends Comparable<? super AnyType>> void quickSelect(AnyType[] a,
			int k) {
	 ...
	 */
	private static <AnyType extends Comparable<? super AnyType>> void quickSelect(AnyType[] a,
...
//		Sort.mergeSort(new Integer[] { 1, 2, 5, 3, 2 });
//		Sort.quicksort(new Integer[] { 1, 2, 5, 3, 2 });
//		Sort.heapsort(new Integer[] { 1, 2, 5, 3, 2 });
//		Arrays.sort(new Integer[] { 1, 2, 5, 3, 2 });
